...
class tf_NarytreeLSTM(object):
    ...
    def train(self,data,sess):
        ...
        for i in range(0,len(data),self.batch_size):
            ...
            feed={self.inputs:input_b, self.tree_str:treestr_b, self.labels:labels_b, self.dropout:self.config.dropout, self.batch_len:len(input_b)}
    ...
    def evaluate(self,data,sess):
        ...
        for i in range(0,len(data),test_batch_size):
            ...
            feed={self.inputs:input_b, self.tree_str:treestr_b, self.labels:labels_b, self.dropout:1.0, self.batch_len:len(input_b)}
